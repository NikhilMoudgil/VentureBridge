      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md dark:bg-zinc-950/80">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-8">
          ...
          <nav className="hidden gap-6 md:flex">
            <Link to="/dashboard" className="text-sm font-medium text-zinc-600 hover:text-zinc-900">Home</Link>
            <Link to="/dashboard/network" className="text-sm font-medium text-zinc-600 hover:text-zinc-900">Network</Link>
            <Link to="/dashboard/messages" className="text-sm font-medium text-zinc-600 hover:text-zinc-900">Messages</Link>
          </nav>
